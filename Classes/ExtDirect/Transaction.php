 ...
 * @scope prototype
 */
class Tx_MvcExtjs_ExtDirect_Transaction {
	 ...
	 *
	 * @var Tx_MvcExtjs_ExtDirect_Request
	 */
	protected $request;
	 ...
	 *
	 * @param Tx_MvcExtjs_ExtDirect_Request $request The direct request this transaction belongs to
	 ...
	 */
	public function __construct(Tx_MvcExtjs_ExtDirect_Request $request, $action, $method, array $data, $tid) {
	...
	public function buildResponse() {
		return $this->objectManager->create('Tx_MvcExtjs_ExtDirect_TransactionResponse');
	}
